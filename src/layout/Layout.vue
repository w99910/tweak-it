            ...
            <div class="w-full sticky top-0 flex items-center justify-center z-20 bg-transparent backdrop-blur px-4">
                <header id="header"
                    ...
                    <nav v-show="data.width > 640 || data.showNav"
                        ...
                        <a href="https://doc.tweakit.today" target="_blank"
                            class="text-lg no-underline">Documentation</a>
                    ...
                    <svg v-show="!data.showNav" @click="data.showNav = true" xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round"
                        class="lucide sm:hidden lucide-menu cursor-pointer">
