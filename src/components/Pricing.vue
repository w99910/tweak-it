...
<template>
    <section ref="r" id="pricing"
        class="flex border-[dashed] sm:px-0 px-2 border-dashed flex-col z-10 w-full items-center py-[10vh]">
        ...
        <div
            ...
            <div class="flex w-full sm:w-1/2  sm:p-8 flex-col gap-y-4">
                <div class="flex gap-x-2 items-center font-semibold">
                    <h2 class="text-primary text-2xl sm:text-3xl">Free Tier - Forever</h2>
                </div>
            ...
            <div class="flex flex-col w-full sm:w-1/2 xl:p-8 sm:p-4 sm:mt-0 mt-10 gap-y-8">
                <div class="flex items-center gap-x-4 sm:gap-x-6 text-primary">
        ...
        <div id="subscription"
            ...
            <div class="flex w-full sm:w-1/2  sm:p-8 flex-col gap-y-4">
                <div class="flex items-center gap-x-2">
                    <h3 class="text-lg text-orange-400">50% Discount - Use <em class="font-semibold">EARLYBIRDS</em>
                        Promo code at checkout</h3>
                </div>
                <div class="flex w-full flex-col mt-6">
                    <div class="flex gap-x-2 items-center font-semibold">
                        <h3 class="text-gray-300 text-lg sm:text-xl line-through">$20.00</h3>
                        <h2 class="text-primary text-2xl sm:text-3xl">$10.00</h2>
                        <p>/ lifetime</p>
                    </div>
                    <div class="mt-6">
            ...
            <div class="flex flex-col w-full sm:w-1/2 xl:p-8 sm:p-4 sm:mt-0 mt-10 gap-y-8">
                <div class="flex items-center gap-x-4 sm:gap-x-6 text-primary">
                    <div v-html="tick" class="w-6 h-6"></div>
                    <p class="">Everything in Free Tier</p>
                </div>
                <div class="flex items-center gap-x-4 sm:gap-x-6 text-primary">
                    <div v-html="tick" class="w-6 h-6"></div>
                ...
                <div class="flex items-center gap-x-4 sm:gap-x-6 text-primary">
                    <div v-html="tick" class="w-6 h-6"></div>
                    <p class="">Sync settings across your browsers</p>
                </div>
                <div class="flex items-center gap-x-4 sm:gap-x-6 text-primary">
                    <div v-html="tick" class="w-6 h-6"></div>
                ...
                <div class="flex items-center gap-x-4 sm:gap-x-6 text-primary">
                    <div v-html="tick" class="w-6 h-6"></div>
                    <p class="">Priority Email Support</p>
                </div>
                <div class="flex items-center gap-x-4 sm:gap-x-6 text-primary">
                    <div v-html="tick" class="w-6 h-6"></div>
